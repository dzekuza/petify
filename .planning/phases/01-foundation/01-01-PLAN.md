...
must_haves:
  truths:
    ...
    - "Chat UI works with only two public entry points (ChatButton, ChatDialog) — ruixen-mono-chat.tsx retained as internal dependency, chat-page.tsx retained as distinct page layout — 4 redundant chat files deleted"
