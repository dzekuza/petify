            ...
            <div className="mb-6 grid grid-cols-2 gap-4">
              <div>
                ...
                <div className="relative">
                  <select
                    className="flex h-9 w-full items-center justify-between rounded-md border border-neutral-200 bg-transparent px-3 py-2 text-sm placeholder:text-muted-foreground outline-none focus-visible:border-neutral-400 hover:border-neutral-300 disabled:cursor-not-allowed disabled:opacity-50 mt-2 appearance-none transition-colors"
                    value={selectedPetId}
